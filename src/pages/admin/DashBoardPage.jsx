...
const DashBoardPage = ({ data, setLimit, onRemove }) => {
          ...
          {isAdminPage ? (
            <>
              <Link to="/admin/add_product">
                <button className="bg-green-700 text-white px-5 py-2 rounded-xl mb-3">
                  Add New Product
                </button>
              </Link>
